...
import { Text, View, Dimensions, Modal, TouchableWithoutFeedback, Animated, ScrollView, Easing,Platform } from 'react-native'
import * as utils from './utils'
import styles2 from './styles'

const WARN_COLOR = '#000'
const MAX_HEIGHT = Dimensions.get('window').height * 0.7

class ActionSheet extends React.Component {
  static defaultProps = {
    tintColor: '#000',
    buttonUnderlayColor: '#000',
    onPress: () => {},
    styles: {}
  }
